...
Else {
    ...
    if ($isDomain) {
        ...
        # Fix list
        $PCFixList = @('S-ADRegistration','S-DC-SubnetMissing','S-PwdNeverExpires','P-Delegated','P-RecycleBin','P-SchemaAdmin','P-UnprotectedOU','A-MinPwdLen','A-PreWin2000AuthenticatedUsers','A-LAPS-NOT-Installed')
        # Fix loop
        ...
        foreach ($GPO in $DomainSettings.Settings.GroupPolicies.Gpo) {
            ...
            Try {
                ...
                Else {
                    ...
                    [void](Set-GPLink -Name $gpo.Name -Target $gpPath -LinkEnabled Yes -ErrorAction Stop)
